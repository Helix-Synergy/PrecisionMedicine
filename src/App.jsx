  ...
  return (
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route path=  "/precisionmedicine-orators" element={<Orators />} />
        <Route path="/about-precisionmedicine-conclave" element={<AboutOralMed />} />
        <Route path="/precisionmedicine-event-schedule"  element={<EventSchedule />} />
        <Route path="/venue" element={<Venue/>}/>
        <Route path="/contact" element={<ContactForm />} />
        <Route path="/precisionmedicine-tracks/"  element={<RotatingLogos />} />
